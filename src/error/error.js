...
const ACCESS_DENIED_ERR = "Access deny for normal user";

module.exports = {
    API_ENDPOINT_NOT_FOUND_ERR, SERVER_ERR, AUTH_HEADER_MISSING_ERR, AUTH_TOKEN_MISSING_ERR, JWT_DECODE_ERR, USER_NOT_FOUND_ERR,
    ACCESS_DENIED_ERR 
}